...
@Component({
  selector: 'app-job-list-bord',
  templateUrl: './job-list-bord.component.html',
  styleUrls: ['./job-list-bord.component.css']
})
export class JobListBordComponent implements OnInit {
